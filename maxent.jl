...
# Purpose
# =======
# Julia code that computes the maximum entropy (maxent) basis functions and
...
# Main variables that are computed in this function
#---------------------------------------------------------------------------
...
#---------------------------------------------------------------------------
    ...
    (phi,phider,contribute,len,lambda) = computephi(dim,compute,prior_type,gamma,
                                                    ilambda,rtol,x,ncoord,n,
                                                    h_node,unstructured)
